...
- [Next.js 설치](https://nextjs.org/docs/app/getting-started/installation) <span class="print-url" data-print-url="true">(웹 주소: https://nextjs.org/docs/app/getting-started/installation)</span>
