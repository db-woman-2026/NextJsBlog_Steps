...
| `step-22` | [lecture/step-22.md](./step-22.md) | [overview/step-22.md](../overview/step-22.md) | 게시글 작성/수정 form과 Contact form에 같은 Tailwind 입력/버튼 패턴을 적용합니다. |
| `step-23` | [lecture/step-23.md](./step-23.md) | [overview/step-23.md](../overview/step-23.md) | 삭제 버튼, 전역 404, 상세 404, Error 화면을 Tailwind로 정리해 기본 UI 전환을 마무리합니다. |
