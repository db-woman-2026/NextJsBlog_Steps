...
권장 시간은 50분입니다. 이 문서의 diff는 `step-10` 완료 코드에 적용합니다. `step-11` branch는 아래 변경이 이미 반영된 완성본입니다.
...
제출 버튼을 빠르게 두 번 눌러 중복 요청이 막히는지 확인합니다. 결과와 확인 방법을 한 문장으로 기록합니다. 실험을 위해 바꾼 값은 다음 단계 전에 복구합니다.
