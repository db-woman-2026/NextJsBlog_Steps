...
실제 완성 코드는 [step-9 브랜치](https://github.com/db-woman-2026/NextJsBlog_Steps/tree/step-9) 기준입니다.
...
- README를 단계형 프로젝트 설명에 맞게 정리합니다.
- 더 이상 쓰지 않는 create-next-app 기본 자산을 삭제합니다.
- 기본 블로그 실습의 라우트와 API 흐름을 다시 확인합니다.
...
| 상태 | 파일 | 확인 링크 |
| --- | --- | --- |
| 수정 | `README.md` | [README.md](https://github.com/db-woman-2026/NextJsBlog_Steps/blob/step-9/README.md) |
| 삭제 | `app/favicon.ico` | [app/favicon.ico](https://github.com/db-woman-2026/NextJsBlog_Steps/blob/step-8/app/favicon.ico) |
| 삭제 | `public/file.svg` | [public/file.svg](https://github.com/db-woman-2026/NextJsBlog_Steps/blob/step-8/public/file.svg) |
| 삭제 | `public/globe.svg` | [public/globe.svg](https://github.com/db-woman-2026/NextJsBlog_Steps/blob/step-8/public/globe.svg) |
| 삭제 | `public/next.svg` | [public/next.svg](https://github.com/db-woman-2026/NextJsBlog_Steps/blob/step-8/public/next.svg) |
| 삭제 | `public/vercel.svg` | [public/vercel.svg](https://github.com/db-woman-2026/NextJsBlog_Steps/blob/step-8/public/vercel.svg) |
| 삭제 | `public/window.svg` | [public/window.svg](https://github.com/db-woman-2026/NextJsBlog_Steps/blob/step-8/public/window.svg) |
...
이 단계에서는 `app/favicon.ico` 파일을 삭제합니다.
...
삭제 전 파일은 [step-8의 app/favicon.ico](https://github.com/db-woman-2026/NextJsBlog_Steps/blob/step-8/app/favicon.ico)에서 확인할 수 있습니다.

### 3. public/file.svg

이 단계에서는 `public/file.svg` 파일을 삭제합니다.
...
삭제 전 파일은 [step-8의 public/file.svg](https://github.com/db-woman-2026/NextJsBlog_Steps/blob/step-8/public/file.svg)에서 확인할 수 있습니다.

### 4. public/globe.svg

이 단계에서는 `public/globe.svg` 파일을 삭제합니다.
...
삭제 전 파일은 [step-8의 public/globe.svg](https://github.com/db-woman-2026/NextJsBlog_Steps/blob/step-8/public/globe.svg)에서 확인할 수 있습니다.

### 5. public/next.svg

이 단계에서는 `public/next.svg` 파일을 삭제합니다.
...
삭제 전 파일은 [step-8의 public/next.svg](https://github.com/db-woman-2026/NextJsBlog_Steps/blob/step-8/public/next.svg)에서 확인할 수 있습니다.

### 6. public/vercel.svg

이 단계에서는 `public/vercel.svg` 파일을 삭제합니다.
...
삭제 전 파일은 [step-8의 public/vercel.svg](https://github.com/db-woman-2026/NextJsBlog_Steps/blob/step-8/public/vercel.svg)에서 확인할 수 있습니다.

### 7. public/window.svg

이 단계에서는 `public/window.svg` 파일을 삭제합니다.
...
삭제 전 파일은 [step-8의 public/window.svg](https://github.com/db-woman-2026/NextJsBlog_Steps/blob/step-8/public/window.svg)에서 확인할 수 있습니다.
...
- README의 실행 방법과 라우트 목록이 현재 기능과 맞는지 확인합니다.
- 삭제한 기본 public SVG 파일을 코드에서 참조하지 않는지 확인합니다.
...
새로운 화면 기능은 `step-8`까지 모두 들어갔습니다. 이 단계에서는 저장소를 수업용 산출물로 보기 좋게 정리하고, 전체 흐름을 다시 점검합니다.
