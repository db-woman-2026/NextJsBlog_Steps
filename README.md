...
`main`은 `create-next-app` 직후의 기본 프로젝트 상태입니다. `basic-1`부터는 이전 단계 위에 코드를 누적해서, 마지막 `basic-9` 브랜치가 기본 블로그 기능의 최종 산출물이 됩니다.
...
| `basic-1` | App Router 기본 페이지, Header, Footer, nav 구성 |
